#include "vtkCustomStreamPoints.h"
...
vtkStandardNewMacro(vtkCustomStreamPoints);

// Construct object with time increment set to 1.0.
vtkCustomStreamPoints::vtkCustomStreamPoints()
{
	this->TimeIncrement = 1.0;
	this->NumberOfStreamers = 0;
}

int vtkCustomStreamPoints::RequestData(
	vtkInformation *,
...
void vtkCustomStreamPoints::PrintSelf(ostream& os, vtkIndent indent)
{

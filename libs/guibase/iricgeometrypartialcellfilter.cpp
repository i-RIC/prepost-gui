...
vtkStandardNewMacro(iricGeometryPartialCellFilter);
vtkCxxSetObjectMacro(iricGeometryPartialCellFilter, Locator, vtkIncrementalPointLocator)

//----------------------------------------------------------------------------
// Construct with all types of clipping turned off.
iricGeometryPartialCellFilter::iricGeometryPartialCellFilter()
{
  this->PointMinimum = 0;
...
void iricGeometryPartialCellFilter::SetExtent(double xMin, double xMax, double yMin,
...
//----------------------------------------------------------------------------
// Specify a (xmin,xmax, ymin,ymax, zmin,zmax) bounding box to clip data.
void iricGeometryPartialCellFilter::SetExtent(double extent[6])
{
  int i;
...
void iricGeometryPartialCellFilter::SetOutputPointsPrecision(int precision)
{
...
int iricGeometryPartialCellFilter::GetOutputPointsPrecision() const
{
  return this->OutputPointsPrecision;
}

//----------------------------------------------------------------------------
int iricGeometryPartialCellFilter::RequestData(
...
void iricGeometryPartialCellFilter::CreateDefaultLocator()
{
  if ( this->Locator == nullptr )
  {
...
//----------------------------------------------------------------------------
int iricGeometryPartialCellFilter::FillInputPortInformation(int, vtkInformation *info)
{
...
//----------------------------------------------------------------------------
void iricGeometryPartialCellFilter::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
vtkMTimeType iricGeometryPartialCellFilter::GetMTime()
{
...
//----------------------------------------------------------------------------
void iricGeometryPartialCellFilter::PolyDataExecute(vtkDataSet *dataSetInput,
                                        vtkPolyData *output)
{
...
//----------------------------------------------------------------------------
void iricGeometryPartialCellFilter::UnstructuredGridExecute(vtkDataSet *dataSetInput,
                                                vtkPolyData *output)
{
...
//----------------------------------------------------------------------------
void iricGeometryPartialCellFilter::StructuredGridExecute(vtkDataSet *dataSetInput,
                                              vtkPolyData *output,
                                              vtkInformation *)
{
  vtkIdType cellId, newCellId;
...
//----------------------------------------------------------------------------
int iricGeometryPartialCellFilter::RequestUpdateExtent(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{

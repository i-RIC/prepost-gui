...
RawDataPointmapInterpolatePoints::~RawDataPointmapInterpolatePoints()
{
	delete ui;
}

void RawDataPointmapInterpolatePoints::reject()
{
	QDialog::reject();
}

void RawDataPointmapInterpolatePoints::accept()
{

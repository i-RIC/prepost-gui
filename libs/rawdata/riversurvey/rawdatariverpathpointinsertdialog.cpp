...
RawDataRiverPathPointInsertDialog::~RawDataRiverPathPointInsertDialog()
{
	delete ui;
}

void RawDataRiverPathPointInsertDialog::initializeItems()
{
...
class RawDataRiverPathPointInsertCommand : public QUndoCommand
{
public:
...
void RawDataRiverPathPointInsertDialog::accept()
{
	...
	updatePoint();
	iRICUndoStack::instance().push(new RawDataRiverPathPointInsertCommand(false, m_insertTarget, m_newPoint, m_rs));
	QDialog::accept();
}
...
void RawDataRiverPathPointInsertDialog::apply()
{
	...
	updatePoint();
	iRICUndoStack::instance().push(new RawDataRiverPathPointInsertCommand(true, m_insertTarget, m_newPoint, m_rs));
	m_applyed = true;
}
...
void RawDataRiverPathPointInsertDialog::updatePoint()
{
...
void RawDataRiverPathPointInsertDialog::setDefaultName()
{
	double small = 0.01;
	double offset = 10;

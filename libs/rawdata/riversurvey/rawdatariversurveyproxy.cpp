...
RawDataRiverSurveyProxy::~RawDataRiverSurveyProxy()
{
...
void RawDataRiverSurveyProxy::doLoadFromProjectMainFile(const QDomNode& node)
{
...
void RawDataRiverSurveyProxy::doSaveToProjectMainFile(QXmlStreamWriter& writer)
{
...
private:
	...
	RawDataRiverSurveyProxy* m_survey;
};

void RawDataRiverSurveyProxy::updateZDepthRangeItemCount(ZDepthRange& range)
{
...
QDialog* RawDataRiverSurveyProxy::propertyDialog(QWidget* parent)
{
	RawDataRiverSurveyDisplaySettingDialog* dialog = new RawDataRiverSurveyDisplaySettingDialog(parent);

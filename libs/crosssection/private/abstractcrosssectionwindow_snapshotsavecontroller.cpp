...
#include "abstractcrosssectionwindow_snapshotsavecontroller.h"
...
AbstractCrosssectionWindow::SnapshotSaveController::SnapshotSaveController(AbstractCrosssectionWindow* window) :
...
void AbstractCrosssectionWindow::SnapshotSaveController::save()
{
	m_canceled = false;
...
void AbstractCrosssectionWindow::SnapshotSaveController::cancel()
{
	m_canceled = true;
}

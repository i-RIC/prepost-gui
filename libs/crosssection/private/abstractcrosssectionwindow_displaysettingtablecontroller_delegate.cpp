...
namespace {
	...
	{
		QPushButton button(AbstractCrosssectionWindow::tr("Setting"));
...
AbstractCrosssectionWindow::DisplaySettingTableController::Delegate::Delegate(QObject* parent) :
	QItemDelegate {parent}
{}

void AbstractCrosssectionWindow::DisplaySettingTableController::Delegate::paint(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{

...
GridCreatingConditionCompoundChannel::GridCreatingConditionCompoundChannel(ProjectDataItem* parent, GridCreatingConditionCreator* creator) :
	...
	m_addVertexAction {new QAction(QIcon(":/libs/guibase/images/iconAddPolygonVertex.svg"), tr("&Add Vertex"), this)},
	m_removeVertexAction {new QAction(QIcon(":/libs/guibase/images/iconRemovePolygonVertex.svg"), tr("&Remove Vertex"), this)},

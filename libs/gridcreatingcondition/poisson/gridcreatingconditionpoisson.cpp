...
GridCreatingConditionPoisson::Impl::Impl(GridCreatingConditionPoisson *parent) :
	...
	m_addVertexAction {new QAction(QIcon(":/libs/guibase/images/iconAddPolygonVertex.svg"), GridCreatingConditionPoisson::tr("&Add Vertex"), parent)},
	m_removeVertexAction {new QAction(QIcon(":/libs/guibase/images/iconRemovePolygonVertex.svg"), GridCreatingConditionPoisson::tr("&Remove Vertex"), parent)},
	m_importCenterLineAction {new QAction(QIcon(":/libs/guibase/images/iconImport.svg"), GridCreatingConditionPoisson::tr("Import C&enter Line..."), parent)},
	m_exportCenterLineAction {new QAction(QIcon(":/libs/guibase/images/iconExport.svg"), GridCreatingConditionPoisson::tr("Export Ce&nter Line..."), parent)},
	m_editCenterLineCoordsAction {new QAction(GridCreatingConditionPoisson::tr("Edit Cen&ter Line Coordinates..."), parent)},
	m_importLeftBankLineAction {new QAction(QIcon(":/libs/guibase/images/iconImport.svg"), GridCreatingConditionPoisson::tr("Import &Left Bank Line..."), parent)},
	m_exportLeftBankLineAction {new QAction(QIcon(":/libs/guibase/images/iconExport.svg"), GridCreatingConditionPoisson::tr("Export Le&ft Bank Line..."), parent)},
	m_editLeftBankLineCoordsAction {new QAction(GridCreatingConditionPoisson::tr("Edit Left Bank Line &Coordinates..."), parent)},
	m_importRightBankLineAction {new QAction(QIcon(":/libs/guibase/images/iconImport.svg"), GridCreatingConditionPoisson::tr("&Import Right Bank Line..."), parent)},
	m_exportRightBankLineAction {new QAction(QIcon(":/libs/guibase/images/iconExport.svg"), GridCreatingConditionPoisson::tr("Export Ri&ght Bank Line..."), parent)},

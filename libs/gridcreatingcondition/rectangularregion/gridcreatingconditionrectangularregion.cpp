...
void GridCreatingConditionRectangularRegion::mouseMoveEvent(QMouseEvent* event, PreProcessorGraphicsViewI* /*v*/)
{
...
void GridCreatingConditionRectangularRegion::mousePressEvent(QMouseEvent* event, PreProcessorGraphicsViewI* /*v*/)
{
...
void GridCreatingConditionRectangularRegion::mouseReleaseEvent(QMouseEvent* event, PreProcessorGraphicsViewI* v)
{
	if (event->button() == Qt::LeftButton) {
...
v4Structured2dGrid* GridCreatingConditionRectangularRegion::createGridInner(double xmin, double xmax, double ymin, double ymax, double stepSize)
{
...
void GridCreatingConditionRectangularRegion::hidePreviewGrid()
{
	m_mouseEventMode = meNormal;
...
void GridCreatingConditionRectangularRegion::informSelection(PreProcessorGraphicsViewI* v)
{
	updateMouseCursor(v);
}

void GridCreatingConditionRectangularRegion::informDeselection(PreProcessorGraphicsViewI* v)
{
	v->unsetCursor();
}
...
void GridCreatingConditionRectangularRegion::updateMouseCursor(PreProcessorGraphicsViewI* v)
{

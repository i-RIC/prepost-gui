#ifndef GRIDCREATINGCONDITIONRECTANGULARREGION_H
#define GRIDCREATINGCONDITIONRECTANGULARREGION_H
...
class GridCreatingConditionRectangularRegion : public GridCreatingCondition
{
	Q_OBJECT
public:
	enum MouseEventMode {

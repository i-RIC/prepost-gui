#include "post3dwindowparticlesscalargroupdataitem_setsettingcommand.h"
...
Post3dWindowParticlesScalarGroupDataItem::SetSettingCommand::SetSettingCommand(const ScalarSettingContainer& setting, const LookupTableContainer& ltc, int size, const QColor& color, const QString& colorbarTitle, Post3dWindowParticlesScalarGroupDataItem* item) :
...
void Post3dWindowParticlesScalarGroupDataItem::SetSettingCommand::redo()
{
	applySetting(m_newSetting, m_newLookupTable, m_newSize, m_newColor, m_newScalarBarTitle);
}

void Post3dWindowParticlesScalarGroupDataItem::SetSettingCommand::undo()
{
	applySetting(m_oldSetting, m_oldLookupTable, m_oldSize, m_oldColor, m_oldScalarBarTitle);
}

void Post3dWindowParticlesScalarGroupDataItem::SetSettingCommand::applySetting(const ScalarSettingContainer& setting, const LookupTableContainer& LookupTable, int size, const QColor& color, const QString& title)
{

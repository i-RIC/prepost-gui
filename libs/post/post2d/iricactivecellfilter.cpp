...
vtkStandardNewMacro(iricActiveCellFilter);

//----------------------------------------------------------------------------
// based on a combination of vtkGeometryFilter and vtkClipPolyData
iricActiveCellFilter::iricActiveCellFilter()
{
	this->Value = 0.0;
	this->CellClipping = 0;
	this->InsideOut = 0;
...
//----------------------------------------------------------------------------
int iricActiveCellFilter::RequestData(
...
//----------------------------------------------------------------------------
int iricActiveCellFilter::FillInputPortInformation(int, vtkInformation *info)
{
...
//----------------------------------------------------------------------------
void iricActiveCellFilter::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void iricActiveCellFilter::PolyDataExecute(vtkDataSet *dataSetInput,
	vtkPolyData *output,
	vtkInformation *outInfo)
{
	...
	if (da == nullptr)
	{
		vtkErrorMacro(<< "No IBC scalars (use polyData->GetCellData()->SetActiveScalars)");
	}
	if ((!this->CellClipping))
	{
		allVisible = 1;
	...
	if (allVisible || da == nullptr) //just pass input to output
	{
...
//----------------------------------------------------------------------------
void iricActiveCellFilter::UnstructuredGridExecute(vtkDataSet *dataSetInput,
	vtkPolyData *output,
	vtkInformation *outInfo)
{
...
//----------------------------------------------------------------------------
void iricActiveCellFilter::StructuredGridExecute(vtkDataSet *dataSetInput,
	vtkPolyData *output,
	vtkInformation *outInfo)
{
	vtkIdType cellId, newCellId;
...
//----------------------------------------------------------------------------
int iricActiveCellFilter::RequestUpdateExtent(
	vtkInformation *vtkNotUsed(request),
	vtkInformationVector **inputVector,
	vtkInformationVector *outputVector)
{

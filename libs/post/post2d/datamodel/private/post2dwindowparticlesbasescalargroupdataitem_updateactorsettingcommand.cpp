...
Post2dWindowParticlesBaseScalarGroupDataItem::UpdateActorSettingCommand::UpdateActorSettingCommand(bool apply, QUndoCommand* settingCommand, QUndoCommand* colorMapCommand, Post2dWindowParticlesBaseScalarGroupDataItem* item) :
	m_apply {apply},
...
void Post2dWindowParticlesBaseScalarGroupDataItem::UpdateActorSettingCommand::redo()
{
...
void Post2dWindowParticlesBaseScalarGroupDataItem::UpdateActorSettingCommand::undo()
{
...
int Post2dWindowParticlesBaseScalarGroupDataItem::UpdateActorSettingCommand::id() const
{
	return iRIC::generateCommandId("Post2dWindowParticlesBaseScalarGroupDataItem::UpdateActorSettingsCommand");
}

bool Post2dWindowParticlesBaseScalarGroupDataItem::UpdateActorSettingCommand::mergeWith(const QUndoCommand* other)
{

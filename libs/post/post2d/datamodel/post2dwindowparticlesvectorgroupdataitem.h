#ifndef POST2DWINDOWPARTICLESVECTORGROUPDATAITEM_H
#define POST2DWINDOWPARTICLESVECTORGROUPDATAITEM_H
...
public:
	...
	Post2dWindowParticlesVectorGroupDataItem(Post2dWindowDataItem* p);
	~Post2dWindowParticlesVectorGroupDataItem();

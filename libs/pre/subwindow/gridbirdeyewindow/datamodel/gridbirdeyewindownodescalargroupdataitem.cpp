...
void GridBirdEyeWindowNodeScalarGroupDataItem::informSelection(VTKGraphicsView* v)
{
	auto cs = activeColorMapSetting();
	if (cs != nullptr) {
...
void GridBirdEyeWindowNodeScalarGroupDataItem::informDeselection(VTKGraphicsView* v)
{
	auto cs = activeColorMapSetting();
	if (cs != nullptr) {

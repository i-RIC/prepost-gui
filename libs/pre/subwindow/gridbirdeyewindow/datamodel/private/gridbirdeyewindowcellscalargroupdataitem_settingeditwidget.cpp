...
#include "gridbirdeyewindowcellscalargroupdataitem_settingeditwidget.h"
#include "gridbirdeyewindowcellscalargroupdataitem_updatesettingcommand.h"
#include "ui_gridbirdeyewindowcellscalargroupdataitem_settingeditwidget.h"
...
GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::SettingEditWidget(GridBirdEyeWindowCellScalarGroupDataItem* item, QWidget *parent) :
	ModifyCommandWidget {parent},
	m_colorMapEditWidget {nullptr},
	m_colorMapEditWidgetWithImportExport {nullptr},
	m_item {item},
	ui(new Ui::GridBirdEyeWindowCellScalarGroupDataItem_SettingEditWidget)
{
	ui->setupUi(this);
	...
	if (m_nodeValueNames.size() == 0) {ui->nodeScalarComboBox->setDisabled(true);}
	...
	if (m_cellValueNames.size() == 0) {ui->cellScalarComboBox->setDisabled(true);}
...
GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::~SettingEditWidget()
{
	delete ui;
}

QUndoCommand* GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::createModifyCommand(bool apply)
{
	auto s = setting();
...
GridBirdEyeWindowCellScalarGroupDataItem::Setting GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::setting() const
{
	Setting setting;
...
void GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::setSetting(const Setting& setting)
{
...
void GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::handleNodeRadioButtonClick()
{
	handleNodeScalarChange(ui->nodeScalarComboBox->currentIndex());
}

void GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::handleCellRadioButtonClick()
{
	handleCellScalarChange(ui->cellScalarComboBox->currentIndex());
}

void GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::handleNodeScalarChange(int index)
{
...
void GridBirdEyeWindowCellScalarGroupDataItem::SettingEditWidget::handleCellScalarChange(int index)
{

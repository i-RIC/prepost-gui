#include "preprocessorgridcrosssectionwindow2_csvexportcontroller.h"
...
PreProcessorGridCrosssectionWindow2::CsvExportController::CsvExportController(PreProcessorGridCrosssectionWindow2* window) :
...
void PreProcessorGridCrosssectionWindow2::CsvExportController::save()
{
	m_canceled = false;
...
void PreProcessorGridCrosssectionWindow2::CsvExportController::cancel()
{
	m_canceled = true;
}

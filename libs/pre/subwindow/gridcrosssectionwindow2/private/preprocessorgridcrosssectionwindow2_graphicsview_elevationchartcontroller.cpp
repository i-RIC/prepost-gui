...
#include "preprocessorgridcrosssectionwindow2_graphicsview_elevationchartcontroller.h"
...
PreProcessorGridCrosssectionWindow2::GraphicsView::ElevationChartController::ElevationChartController(GraphicsView* view) :
	m_graphicsView {view}
{}

void PreProcessorGridCrosssectionWindow2::GraphicsView::ElevationChartController::paint(

...
PreProcessorGridCrosssectionWindow2::GridAttributeDisplaySettingContainer::GridAttributeDisplaySettingContainer(SolverDefinitionGridAttribute* att) :
	...
	elevationChartIndexFont {"elevationChartIndexFont", QFont("Arial", 12)},
	...
	independentChartTitleFont {"independentChartTitleFont", QFont("Arial", 12)},
	independentChartAxisFont {"independentChartAxisFont", QFont("Arial", 10)},
	...
	colorMapTitleFont {"colorMapTitleFont", QFont("Arial", 12)},

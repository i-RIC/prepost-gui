#include "preprocessorgridcrosssectionwindow2_graphicsview_independentchartcontroller.h"
...
PreProcessorGridCrosssectionWindow2::GraphicsView::IndependentChartController::IndependentChartController(GraphicsView* view) :
	m_graphicsView {view}
{}

void PreProcessorGridCrosssectionWindow2::GraphicsView::IndependentChartController::paint(
...
void PreProcessorGridCrosssectionWindow2::GraphicsView::IndependentChartController::drawNodeLine(
		const std::vector<double>& nodePositions, const std::vector<QVariant>& values,
		GridAttributeDisplaySettingContainer* setting,
...
void PreProcessorGridCrosssectionWindow2::GraphicsView::IndependentChartController::drawCellLine(
		const std::vector<double>& nodePositions, const std::vector<QVariant>& values,
		GridAttributeDisplaySettingContainer* setting,
		QMatrix& xMatrix, QMatrix& yMatrix, QPainter* painter)
{
...
void PreProcessorGridCrosssectionWindow2::GraphicsView::IndependentChartController::drawTitle(
		GridAttributeDisplaySettingContainer* setting,
...
void PreProcessorGridCrosssectionWindow2::GraphicsView::IndependentChartController::drawScale(
...
QMatrix PreProcessorGridCrosssectionWindow2::GraphicsView::IndependentChartController::matrix(const DrawRegionInformation& info, double min, double max)
{

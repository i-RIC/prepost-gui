...
GeoDataPointmap::PolygonsManager::GeoDataTopDataItem::GeoDataTopDataItem(SolverDefinitionGridAttribute* cond, GridTypeDataItem* gridTypeDataItem, PreProcessorDataItem* parent) :
	PreProcessorGeoDataTopDataItemI("", QIcon(), gridTypeDataItem),
...
const QList<PreProcessorGeoDataGroupDataItemI*> GeoDataPointmap::PolygonsManager::GeoDataTopDataItem::groupDataItems() const
{
	QList<PreProcessorGeoDataGroupDataItemI*> empty;
	return empty;
}

PreProcessorGeoDataGroupDataItemI* GeoDataPointmap::PolygonsManager::GeoDataTopDataItem::groupDataItem(const std::string& /*name*/) const
{
	return nullptr;
}

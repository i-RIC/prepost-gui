...
GeoDataPointmap::PolygonsManager::GeoDataDataItem::GeoDataDataItem(GeoDataGroupDataItem* group, PreProcessorDataItem* parent) :
	PreProcessorGeoDataDataItemInterface(parent),
...
PreProcessorGeoDataGroupDataItemInterface* GeoDataPointmap::PolygonsManager::GeoDataDataItem::groupDataItem() const
{
	return m_group;
}

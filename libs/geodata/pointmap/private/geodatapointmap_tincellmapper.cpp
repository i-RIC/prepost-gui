...
GeoDataPointmap::TinCellMapper::TinCellMapper(QObject* parent) :
	GeoDataCellMapperT<double, vtkDoubleArray>("Pointmap cell mapper with TIN", parent)
{}

GeoDataMapperSettingI* GeoDataPointmap::TinCellMapper::initialize(bool* boolMap)
{
	auto s = new ::Setting();
...
void GeoDataPointmap::TinCellMapper::map(bool* boolMap, GeoDataMapperSettingI* s)
{
...
void GeoDataPointmap::TinCellMapper::terminate(GeoDataMapperSettingI* s)
{
	delete s;
}

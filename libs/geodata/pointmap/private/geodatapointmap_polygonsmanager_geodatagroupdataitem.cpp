...
GeoDataPointmap::PolygonsManager::GeoDataGroupDataItem::GeoDataGroupDataItem(SolverDefinitionGridAttribute* cond, GeoDataTopDataItem* topDataItem, PreProcessorDataItem* parent) :
	PreProcessorGeoDataGroupDataItemInterface(cond, topDataItem),
	m_condition {cond},
...
const QList<PreProcessorGeoDataDataItemInterface*> GeoDataPointmap::PolygonsManager::GeoDataGroupDataItem::geoDatas() const
{
	QList<PreProcessorGeoDataDataItemInterface*> empty;
	return empty;
}
...
PreProcessorGeoDataDataItemInterface* GeoDataPointmap::PolygonsManager::GeoDataGroupDataItem::buildGeoDataDataItem()
{
	return nullptr;
}

void GeoDataPointmap::PolygonsManager::GeoDataGroupDataItem::addGeoData(PreProcessorGeoDataDataItemInterface* /*geoData*/)
{}

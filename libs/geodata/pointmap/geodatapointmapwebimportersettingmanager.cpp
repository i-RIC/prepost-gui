...
std::vector<GeoDataPointmapWebImporterSetting> standardSettings()
{
	...
	ret.push_back(buildSetting(GeoDataPointmapWebImporterSettingManager::tr("GSI elevation tiles (FGD DEM)"), 0, 14, "http://cyberjapandata.gsi.go.jp/xyz/dem/{z}/{x}/{y}.txt"));

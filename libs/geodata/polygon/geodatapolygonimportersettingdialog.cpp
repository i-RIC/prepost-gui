#include "ui_geodatapolygonimportersettingdialog.h"
...
GeoDataPolygonImporterSettingDialog::~GeoDataPolygonImporterSettingDialog()
{
	delete ui;
}

void GeoDataPolygonImporterSettingDialog::setLabels(const QStringList& labels)
{
...
void GeoDataPolygonImporterSettingDialog::setData(const QList<QList<QVariant> >& data)
{
...
int GeoDataPolygonImporterSettingDialog::nameIndex() const
{
	return ui->nameComboBox->currentIndex();
}

int GeoDataPolygonImporterSettingDialog::valueIndex() const
{
	return ui->valueComboBox->currentIndex();
}

void GeoDataPolygonImporterSettingDialog::accept()
{
...
void GeoDataPolygonImporterSettingDialog::updateTable()
{
...
GeoDataPolygonImporterSettingDialog::NameSetting GeoDataPolygonImporterSettingDialog::nameSetting() const
{
...
GeoDataPolygonImporterSettingDialog::ValueSetting GeoDataPolygonImporterSettingDialog::valueSetting() const
{
...
QVariant GeoDataPolygonImporterSettingDialog::specifiedValue() const
{

#ifndef GEODATAPOLYGON_DISPLAYSETTING_H
#define GEODATAPOLYGON_DISPLAYSETTING_H
...
class GeoDataPolygon::DisplaySetting : public CompositeContainer
{
public:
...
#endif // GEODATAPOLYGON_DISPLAYSETTING_H

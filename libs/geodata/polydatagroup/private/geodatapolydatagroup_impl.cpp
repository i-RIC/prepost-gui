...
GeoDataPolyDataGroup::Impl::Impl(GeoDataPolyDataGroup* group) :
	...
	m_moveUpAction {new QAction(QIcon(":/libs/guibase/images/iconItemMoveUp.svg"), GeoDataPolyDataGroup::tr("Move up"), group)},
	m_moveDownAction {new QAction(QIcon(":/libs/guibase/images/iconItemMoveDown.svg"), GeoDataPolyDataGroup::tr("Move down"), group)},

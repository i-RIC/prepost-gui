...
public:
	GeoDataNetcdfIntegerImporter(GeoDataCreator* creator) : GeoDataNetcdfImporterT<int, vtkIntArray>(creator) {}
...
public:
	GeoDataNetcdfRealImporter(GeoDataCreator* creator) : GeoDataNetcdfImporterT<double, vtkDoubleArray>(creator) {}

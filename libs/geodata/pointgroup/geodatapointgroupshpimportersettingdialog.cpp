#include "ui_geodatapointgroupshpimportersettingdialog.h"
...
GeoDataPointGroupShpImporterSettingDialog::GeoDataPointGroupShpImporterSettingDialog(const QString& filename, GridAttributeEditWidget* widget, QWidget* parent) :
	QDialog {parent},
	ui {new Ui::GeoDataPointGroupShpImporterSettingDialog}
{
	ui->setupUi(this);
	m_filename = filename;
...
GeoDataPointGroupShpImporterSettingDialog::~GeoDataPointGroupShpImporterSettingDialog()
{
	delete ui;
}

void GeoDataPointGroupShpImporterSettingDialog::setLabels(const QStringList& labels)
{
...
void GeoDataPointGroupShpImporterSettingDialog::setData(const QList<QList<QVariant> >& data)
{
...
int GeoDataPointGroupShpImporterSettingDialog::nameIndex() const
{
	return ui->nameComboBox->currentIndex();
}

int GeoDataPointGroupShpImporterSettingDialog::valueIndex() const
{
	return ui->valueComboBox->currentIndex();
}

void GeoDataPointGroupShpImporterSettingDialog::accept()
{
...
void GeoDataPointGroupShpImporterSettingDialog::updateTable()
{
...
GeoDataPointGroupShpImporterSettingDialog::NameSetting GeoDataPointGroupShpImporterSettingDialog::nameSetting() const
{
...
GeoDataPointGroupShpImporterSettingDialog::ValueSetting GeoDataPointGroupShpImporterSettingDialog::valueSetting() const
{
...
QVariant GeoDataPointGroupShpImporterSettingDialog::specifiedValue() const
{

...
void GeoDataPointGroup::DisplaySettingWidget::ScaleSizePairTableController::applyToTable()
{
	...
	m_model.setHeaderData(0, Qt::Orientation::Horizontal, DisplaySettingWidget::tr("Value"));
	m_model.setHeaderData(1, Qt::Orientation::Horizontal, DisplaySettingWidget::tr("Size (m)"));

...
GeoDataRiverSurvey::Impl::Impl(GeoDataRiverSurvey* rs) :
	...
	m_addVertexAction {new QAction(QIcon(":/libs/guibase/images/iconAddPolygonVertex.svg"), GeoDataRiverSurvey::tr("&Add Vertex"), rs)},
	m_removeVertexAction {new QAction(QIcon(":/libs/guibase/images/iconRemovePolygonVertex.svg"), GeoDataRiverSurvey::tr("&Remove Vertex"), rs)},
	m_importCenterLineAction {new QAction(QIcon(":/libs/guibase/images/iconImport.svg"), GeoDataRiverSurvey::tr("Import C&enter Line..."), rs)},
	m_exportCenterLineAction {new QAction(QIcon(":/libs/guibase/images/iconExport.svg"), GeoDataRiverSurvey::tr("Export Ce&nter Line..."), rs)},

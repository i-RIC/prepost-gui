#ifndef GRIDCREATINGCONDITIONRIVERSURVEYI_H
#define GRIDCREATINGCONDITIONRIVERSURVEYI_H
...
class GD_RIVERSURVEY_EXPORT GridCreatingConditionRiverSurveyI : public GridCreatingCondition
{
	Q_OBJECT
...
public:
	...
	GridCreatingConditionRiverSurveyI(ProjectDataItem* parent, GridCreatingConditionCreator* creator)
		: GridCreatingCondition(parent, creator) {
	}
	virtual ~GridCreatingConditionRiverSurveyI() {}
...
public:
	GridCreatingConditionCtrlPointMoveCommand(
		bool apply,
		double offset,
		GridCreatingConditionRiverSurveyI* cond, bool noMerge = false)
		: QUndoCommand(GridCreatingConditionRiverSurveyI::tr("Move Control Points")) {
		m_apply = apply;
		m_offset = offset;
		m_condition = cond;
...
private:
	bool m_apply;
	double m_offset;
	GridCreatingConditionRiverSurveyI* m_condition;
...
#endif // GRIDCREATINGCONDITIONRIVERSURVEYI_H

...
GridAttributeContainer* SolverDefinitionGridAttributeReal::buildContainer(v4InputGrid* grid, GridAttributeContainerIoI* io)
{
	return new GridAttributeRealContainer(grid, io, this);
}

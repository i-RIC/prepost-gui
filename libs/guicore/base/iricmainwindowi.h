...
class GUICOREDLL_EXPORT iRICMainWindowI : public QMainWindow
{

public:
	static const int STATUSBAR_DISPLAYTIME = 5000;

	iRICMainWindowI(QWidget* widget);
	virtual ~iRICMainWindowI() {}

	virtual PreProcessorWindowI* preProcessorWindow() const = 0;
	...
	virtual AnimationControllerI* animationController() const = 0;

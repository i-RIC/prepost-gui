...
{
public:
	static bool load(std::map<std::string, vtkPointSetAndValueRangeSetT<vtkPolyData>*>* polyDataMap, std::map<std::string, std::vector<int> >* polyDataCellIdsMap, iRICLib::H5CgnsPolyDataSolution* sol, const QPointF& offset);

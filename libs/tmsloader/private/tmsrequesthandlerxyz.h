...
{
public:
	TmsRequestHandlerXYZ(const QString& url, const QPointF& centerLonLat, const QSize& size, int zoomLevel, int requestId, bool lonLat, const std::map<QString, QString>& options, TmsImageCache* imageCache);
};

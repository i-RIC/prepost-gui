program Test12
	...
	double precision, dimension(:), allocatable:: particlex, particley, particlez
	...
	allocate(particlex(10), particley(10), particlez(10))
	do i = 1, isize
		do j = 1, jsize
			do k = 1, ksize
	...
	do t = 1, 5
		...
		call cg_iric_write_sol_particle_pos3d_f(t, particlex, particley, particlez, ier)
	end do

	deallocate(grid3d_x, grid3d_y, grid3d_z, node3d_real)
	deallocate(particlex, particley, particlez)

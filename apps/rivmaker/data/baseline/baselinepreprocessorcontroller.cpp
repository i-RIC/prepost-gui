...
BaseLinePreProcessorController::Impl::Impl() :
	...
	m_importAction {new QAction(QIcon(":/images/iconImport.png"), BaseLinePreProcessorController::tr("&Import..."), nullptr)},
	m_exportAction {new QAction(QIcon(":/images/iconExport.png"), BaseLinePreProcessorController::tr("&Export..."), nullptr)},
	m_addVertexAction {new QAction(QIcon(":/images/iconAddPolygonVertex.png"), BaseLinePreProcessorController::tr("&Add Vertex"), nullptr)},
	m_removeVertexAction {new QAction(QIcon(":/images/iconRemovePolygonVertex.png"), BaseLinePreProcessorController::tr("&Remove Vertex"), nullptr)},
	m_editCoordinatesAction {new QAction(BaseLinePreProcessorController::tr("&Edit Coordinates..."), nullptr)},
	m_reverseDirectionAction {new QAction(BaseLinePreProcessorController::tr("Reverse &Direction"), nullptr)},
	m_deleteAction {new QAction(QIcon(":/images/iconDeleteItem.png"), BaseLinePreProcessorController::tr("Delete"), nullptr)},
